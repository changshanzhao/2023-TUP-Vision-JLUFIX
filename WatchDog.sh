...
### 
export ROS_HOME="/home/bubing2/TUP-Vision-2023-Based-main/"
cd /home/bubing2/TUP-Vision-2023-Based-main/
# 设置需要启动和监视的ros命令
...
start_commands() {
  for cmd in "${commands[@]}"
  do
	gnome-terminal -- bash -c "source /opt/intel/openvino_2023.0.1/setupvars.sh;source /opt/ros/galactic/setup.bash;cd $(pwd);source install/setup.bash;$cmd;exec bash;"
  done
}
